...
import com.atguigu.mtime.bean.NewsDetailBean;
...
public class NewsBrowserActivity extends BaseActivity {
    ...
    private void getDataFromNet() {
        Log.e("URL", UrlConstants.DETAIL_NEWS + newsId);
    ...
    private void parseData(String s) {
        NewsDetailBean detailBean = JSON.parseObject(s, NewsDetailBean.class);
    ...
    protected void clickShare() {
        ShareUtils.showShare(this, "NewsBrowserActivity()");
    }
